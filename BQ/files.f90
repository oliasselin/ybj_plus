...
!  integer, parameter :: unit_ro_top =78
  ...
  integer, parameter :: unit_s0     =170
  integer, parameter :: unit_s1     =171
  integer, parameter :: unit_s2     =172
  integer, parameter :: unit_s3     =173
  integer, parameter :: unit_s4     =174
  integer, parameter :: unit_s5     =175
  integer, parameter :: unit_s6     =176
  integer, parameter :: unit_s7     =177
  integer, parameter :: unit_s8     =178
  integer, parameter :: unit_s9     =179
...
!      if(mype==0) open (unit=unit_htopg    ,file="htopg.dat"    ,action="write",status="replace")
      ...
      !Time series of (u,v) at various levels for time-frequency analysis
      open (unit=unit_s0       ,file="s0.dat"        ,action="write",status="replace")
      open (unit=unit_s1       ,file="s1.dat"        ,action="write",status="replace")
      open (unit=unit_s2       ,file="s2.dat"        ,action="write",status="replace")
      open (unit=unit_s3       ,file="s3.dat"        ,action="write",status="replace")
      open (unit=unit_s4       ,file="s4.dat"        ,action="write",status="replace")
      open (unit=unit_s5       ,file="s5.dat"        ,action="write",status="replace")
      open (unit=unit_s6       ,file="s6.dat"        ,action="write",status="replace")
      open (unit=unit_s7       ,file="s7.dat"        ,action="write",status="replace")
      open (unit=unit_s8       ,file="s8.dat"        ,action="write",status="replace")
      open (unit=unit_s9       ,file="s9.dat"        ,action="write",status="replace")
