MODULE mpi
  ...
  integer :: tag_slice_xz(nfields) = 141![141,142,143,144,145]  !Up to 14X where X is the number of fields to slice
  integer :: tag_slice_xz2(nfields2) = [1141,1142,1143,1144,1145]  !Up to 114X where X is the number of fields to slice
  ...
  integer :: tag_etaS  = 175
  integer :: tag_etaP  = 176
  integer :: tag_tpf   = 177
  integer :: tag_tps   = 178
