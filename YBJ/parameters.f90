MODULE parameters
   ...
   IMPLICIT NONE
    ...
    integer, parameter :: n1=64, n2=64, n3=256 !n1=256, n2=256, n3=256!n1=64, n2=64, n3=256
...
!    integer, parameter :: plot_energy=1      !Use 1: energy_linear (equivalent to boussinesq including variable density, 2: energy_lipps)
 ...
 !   double precision, parameter :: N0  =  twopi*1e-3  !0.002          !Actual N is s^-1, not squared.    
   ...
   ! ------------ !                                                                                                                         
    ...
    real :: maxtime=100                      
    double precision, parameter :: delt=0.5*Bu*Ro/(2.*ktrunc_x*ktrunc_x) !Ro/10.
    ...
    double precision, parameter :: coeff =0.01!0.01!0.4!0.4!0.1!0.075
