...
for name in run_list:
    for field in field_list:
        for sli in sli_list:
            make_a_gif(run=folder+name,sli=sli,field=field,nmax=200,fixed_cbrange='minmax',cbmin=-0.02,cbmax=0.02,hres=256,vres=256,timestep=0.1,scratch_location=scratch_location,home_location=home_location,U_scale=0.5,L_scale=100000/6.28,cor=1.24e-4)
