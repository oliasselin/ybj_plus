...
timestep = 1.  #Points per inertial period                                                                                                                          
tmax = 51      #Number of IP to be included in plot
...
for u in u_list:
    ...
    np.savetxt('data/'+folder+'ave_error_L1_u'+u+bu+'.dat',ave_error_L1)
    np.savetxt('data/'+folder+'ave_error_L2_u'+u+bu+'.dat',ave_error_L2)
