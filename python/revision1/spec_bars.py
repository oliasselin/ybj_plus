...
plt.xlim(right=2)
plt.ylim((1e-5,1e-0))
plt.axvline(x=(0.8/1.8),linewidth=1., color='k')
plt.axvline(x=(4./3.)  ,linewidth=1., color='k')
plt.text(0.8/1.8, 1.05,r'$\omega=1.2f$')
plt.text(4./3.  , 1.05,r'$\omega=1.5f$')
#plt.show()
plt.savefig('plots/spec_bars.eps')
